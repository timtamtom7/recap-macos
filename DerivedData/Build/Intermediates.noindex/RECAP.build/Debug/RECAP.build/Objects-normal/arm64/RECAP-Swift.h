...
#ifndef RECAP_SWIFT_H
#define RECAP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RECAP",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC5RECAP11AppDelegate")
...
@class NSWindow;
@class NSCoder;
SWIFT_CLASS("_TtC5RECAP20MainWindowController")
...
SWIFT_CLASS("_TtC5RECAP17MenuBarController")
@interface MenuBarController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@interface MenuBarController (SWIFT_EXTENSION(RECAP)) <NSMenuDelegate>
@end

SWIFT_CLASS("_TtC5RECAP20ScreenCaptureService")
...
@interface ScreenCaptureService (SWIFT_EXTENSION(RECAP)) <AVCaptureVideoDataOutputSampleBufferDelegate>
